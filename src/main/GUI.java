		...
		Search.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(flag == false) {
					...
					inf = new JInternalFrame("房間查詢 ",true,true,true,true);
		...
		Reserve.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (flag == false) {
					...
					JInternalFrame inf = new JInternalFrame();
					inf = new JInternalFrame("預訂房間 ",true,true,true,true);
		...
		Modify.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(flag == false) {
					flag = true;
					JInternalFrame inf = new JInternalFrame();
					inf=new JInternalFrame("修改/取消訂單",true,true,true,true);
		...
		Query.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(flag == false) {
					flag = true;
					JInternalFrame inf = new JInternalFrame();
					inf=new JInternalFrame("查詢訂單",true,true,true,true);
